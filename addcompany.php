...
if(isset($_POST)) {
	...
	if($result->num_rows == 0) {
		...
		$sql = "INSERT INTO company(name, companyname, country, state, city, contactno, email, password, aboutme, logo) VALUES ('$name', '$companyname', '$country', '$state', '$city', '$contactno', '$email', '$password', '$aboutme', '$file')";
